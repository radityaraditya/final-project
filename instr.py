...
txt_instruction = ('This application allows you to use the Rufier test to make an initial diagnosis of your health.\n'
                   ...
                   ' The subject lies in the supine position for 5 minutes and has their pulse rate measured for 15 second;\n'
                   'then, within 45 seconds, the subject performs30 squats.\n'
...
txt_test2 = 'Perform 30 squat in 45 seconds. To do this,  click the "Start doing squats"button\nto start the squat counter.'
